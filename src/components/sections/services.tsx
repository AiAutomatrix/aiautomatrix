...
import { BrainCircuit, Bot, DatabaseZap } from 'lucide-react';
...
const services = [
  {
    ...
    description: 'Integrate custom ML models and build scalable, AI-powered data processing pipelines with high-performance APIs.',
    link: '/services/ai-backend-development'
  },
  {
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground mt-4 max-w-2xl mx-auto">
            We build specialized AI solutions that drive efficiency, engagement, and growth for your business.
          </p>
        </div>
